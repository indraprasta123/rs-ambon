...
if (empty($connection)) {
    ...
    // Mengaktifkan output buffering dengan fungsi minify_html untuk meminimalkan HTML
...
<head>
  ...
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic">';
    // Memeriksa apakah modul yang aktif adalah 'history'
    if ($mod == 'history') {
        echo '
...
<div class="loading"><div class="spinner-border text-primary" role="status"></div></div>
  <!-- loader -->
    ...
    <!-- * loader -->';
    // Memeriksa apakah cookie 'COOKIES_MEMBER' ada
...
<!-- App Header -->
    <div class="appHeader bg-danger text-light">
        ...
        <a class="dropdown-item" onclick="location.href='./profile';" href="./profile"><ion-icon size="small"
                name="person-outline"></ion-icon>Profil</a>
        <a class="dropdown-item" onclick="location.href='./logout';" href="./logout"><ion-icon size="small"
                name="log-out-outline"></ion-icon>Keluar</a>
        </div>
        </div>
        </div>
