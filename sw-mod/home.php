<?php
if ($mod == '') {
    // Jika tidak ada modul yang dipanggil, redirect ke halaman 404 dan tampilkan pesan 'kosong'
    header('location:../404');
    echo 'kosong';
} else {
    ...
    if (!isset($_COOKIE['COOKIES_MEMBER'])) {
        // Jika tidak ada cookie, tampilkan form login
        echo '
 <!-- App Capsule -->
    <div id="appCapsule">
    ...
    <!-- * App Capsule -->';
        ...
        // Jika cookie ada, tampilkan dashboard pengguna
        echo '<!-- App Capsule -->
    <div id="appCapsule">
        <!-- Wallet Card -->
    ...
    <div class="section mt-4">
        ...
        // Menampilkan opsi bulan untuk filter absensi
        if ($month == 1) {
            ...
            <div class="card">
                <div class="table-responsive">
                    <table class="table table-dark rounded bg-danger">
                        ...
                        <tbody>';
        // Menampilkan absensi 1 minggu terakhir
