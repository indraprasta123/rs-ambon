...
if ($mod == '') {
    ...
    <div class="card-body">
        ...
        // Mengambil semua data dari tabel present_status dan mengurutkan berdasarkan present_name secara ascending
        $query = "SELECT * from present_status order by present_name ASC";
        $result = $connection->query($query); // Menjalankan query
        while ($row = $result->fetch_assoc()) { // Mengambil setiap baris hasil query sebagai array asosiatif
            // Menampilkan setiap pilihan dalam elemen select dengan nilai id dan teks nama dari data yang diambil
