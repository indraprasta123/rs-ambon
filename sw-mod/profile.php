<?php
if ($mod == '') {
    // Jika variabel $mod kosong, pengguna akan diarahkan ke halaman 404 dan pesan 'kosong' ditampilkan.
    header('location:../404');
    echo 'kosong';
} else {
    ...
    if (!isset($_COOKIE['COOKIES_MEMBER'])) {
        // Mengatur ulang cookie dan mengakhiri sesi
        ...
        session_destroy();
        header("location:./"); // Mengarahkan pengguna ke halaman utama
    } else {
    ...
    <div id="appCapsule">
        <div class="section mt-3 text-center">
            <div class="avatar-section">
                ...
                <a href="#">';
        // Menampilkan avatar pengguna atau gambar default jika tidak ada
        if ($row_user['photo'] == '') {
            ...
            <div class="card">
                <div class="card-body">
                    <form id="update-profile">
                        ...
                        <div class="form-group boxed">
                            <div class="input-wrapper">
                                <label class="label" for="email4">Pangkat</label>
                                <input type="text" class="form-control" id="pangkat" name="pangkat" value="' . $row_user['pangkat'] . '" required>
                                <i class="clear-input">
                                    <ion-icon name="close-circle"></ion-icon>
                                </i>
                            </div>
        ...
        // Mengambil dan menampilkan opsi shift dari database
        ...
        // Mengambil dan menampilkan opsi lokasi penempatan dari database
        ...
        echo '
                        ...
                        <div class="form-group boxed">
                            <div class="input-wrapper">
                                <label class="label" for="password4">Ruang Kerja</label>
        ...
        echo '
                        ...
                        <div class="form-group boxed">
                            <div class="input-wrapper">
                                <label class="label" for="email4">Tempat dan Tanggal lahir</label>
                                <input type="text" class="form-control" id="born" name="born" value="' . $row_user['born'] . '" required>
                                <i class="clear-input">
                                    <ion-icon name="close-circle"></ion-icon>
                                </i>
                            </div>
                        ...
                        <div class="form-group boxed">
                            <div class="input-wrapper">
                                <label class="label" for="email4">Alamat Rumah</label>
                                <input type="text" class="form-control" id="employess_address" name="employess_address" value="' . $row_user['employess_address'] . '" required>
                                <i class="clear-input">
                                    <ion-icon name="close-circle"></ion-icon>
                                </i>
                            </div>
