  ...
  var P = function (h) {
    function W(a) {
      var b,
        c,
        e = {};
      // Loop untuk memproses setiap properti dalam objek a
      h.each(a, function (d) {
        // Memeriksa dan mengubah nama properti sesuai dengan aturan penulisan tertentu
        if (
          (b = d.match(/^([^A-Z]+?)([A-Z])/)) &&
          ...
          (c = d.replace(b[0], b[2].toLowerCase())),
            (e[c] = d),
            // Jika properti diawali dengan 'o', lakukan pemrosesan rekursif pada objek terkait
            "o" === b[1] && W(a[d]);
      });
      a._hungarianMap = e; // Menyimpan peta untuk konversi nama properti
    }
    function H(a, b, c) {
      a._hungarianMap || W(a); // Pastikan peta sudah dibuat
      var e;
      h.each(b, function (d) {
        e = a._hungarianMap[d];
        // Jika properti terkonversi ditemukan, lakukan penggabungan atau penyalinan nilai
        if (e !== k && (c || b[e] === k))
          "o" === e.charAt(0)
            ? (b[e] || (b[e] = {}), h.extend(!0, b[e], b[d]), H(a[e], b[e], c))
            : (b[e] = b[d]);
      });
    }
    function P(a) {
      var b = m.defaults.oLanguage,
        c = a.sZeroRecords;
      // Pengaturan teks tampilan ketika tidak ada data atau saat memuat data
      !a.sEmptyTable &&
        c &&
      ...
      a.sInfoThousands && (a.sThousands = a.sInfoThousands); // Mengatur pemisah ribuan
      (a = a.sDecimal) && db(a); // Mengatur tanda desimal
    }
    function eb(a) {
      // Konversi pengaturan dari bentuk lama ke bentuk baru
      A(a, "ordering", "bSort");
      ...
      // Jika terdapat kolom pencarian, lakukan pengaturan lebih lanjut
      if ((a = a.aoSearchCols))
        for (var b = 0, c = a.length; b < c; b++)
          a[b] && H(m.models.oSearch, a[b]);
    }
    function fb(a) {
      // Konversi pengaturan kolom
      A(a, "orderable", "bSortable");
      A(a, "orderData", "aDataSort");
      A(a, "orderSequence", "asSorting");
      A(a, "orderDataType", "sortDataType");
      // Pastikan aDataSort adalah array
      var b = a.aDataSort;
      b && !h.isArray(b) && (a.aDataSort = [b]);
    }
    function gb(a) {
      // Menguji kemampuan browser terkait dengan scrollbar dan elemen tersembunyi
      var a = a.oBrowser,
        b = h("<div/>")
          .css({
            position: "absolute",
          ...
          .appendTo("body"),
        c = b.find(".test");
      a.bScrollOversize = 100 === c[0].offsetWidth; // Menentukan apakah scrollbar besar
      a.bScrollbarLeft = 1 !== Math.round(c.offset().left); // Menentukan posisi scrollbar
      b.remove(); // Menghapus elemen uji
    }
    function hb(a, b, c, e, d, f) {
      var g,
        j = !1;
      c !== k && ((g = c), (j = !0)); // Inisialisasi nilai awal jika ada
      // Loop untuk memproses setiap elemen dalam rentang tertentu
      for (; e !== d; )
        a.hasOwnProperty(e) &&
          ((g = j ? b(g, a[e], e, a) : a[e]), (j = !0), (e += f));
      return g; // Mengembalikan nilai akhir setelah pemrosesan
    }
    function Fa(a, b) {
      ...
      ka(a, e, h(b).data()); // Memproses data atribut yang terkait dengan elemen kolom
    }
    function ka(a, b, c) {
      var b = a.aoColumns[b], // Mendapatkan kolom spesifik dari array aoColumns
        e = a.oClasses, // Mendapatkan kelas CSS yang digunakan oleh DataTables
        d = h(b.nTh); // Mendapatkan elemen header dari kolom
      if (!b.sWidthOrig) {
        b.sWidthOrig = d.attr("width") || null; // Menyimpan lebar asli dari elemen jika ada
        var f = (d.attr("style") || "").match(/width:\s*(\d+[pxem%]+)/);
        f && (b.sWidthOrig = f[1]); // Menyimpan lebar dari style jika ada
      }
      c !== k &&
        null !== c &&
        (fb(c), // Memproses pengaturan kolom dari parameter c
        H(m.defaults.column, c), // Menggabungkan pengaturan default dan pengaturan pengguna
        c.mDataProp !== k && !c.mData && (c.mData = c.mDataProp), // Menangani properti mDataProp
        c.sType && (b._sManualType = c.sType), // Menyimpan tipe manual jika ada
        c.className && !c.sClass && (c.sClass = c.className), // Menyimpan nama kelas jika ada
        h.extend(b, c), // Menggabungkan pengaturan kolom
        E(b, c, "sWidth", "sWidthOrig"), // Menyalin properti sWidth ke sWidthOrig
        c.iDataSort !== k && (b.aDataSort = [c.iDataSort]), // Menentukan urutan data
        E(b, c, "aDataSort")); // Menyalin properti aDataSort
      var g = b.mData, // Mengambil data yang terkait dengan kolom
        j = R(g), // Fungsi untuk mendapatkan data dari sumber
        i = b.mRender ? R(b.mRender) : null, // Fungsi untuk merender data jika ada
        c = function (a) {
          return "string" === typeof a && -1 !== a.indexOf("@");
        };
      b._bAttrSrc =
        h.isPlainObject(g) && (c(g.sort) || c(g.type) || c(g.filter)); // Menandai apakah data diambil dari atribut
      b.fnGetData = function (a, b, c) {
        var e = j(a, b, k, c); // Mendapatkan data untuk sel tertentu
        return i && b ? i(e, b, a, c) : e; // Mengembalikan data setelah proses render jika ada
      };
      b.fnSetData = function (a, b, c) {
        return S(g)(a, b, c); // Mengatur data untuk sel tertentu
      };
      "number" !== typeof g && (a._rowReadObject = !0); // Menandai jika data diambil sebagai objek
      a.oFeatures.bSort || ((b.bSortable = !1), d.addClass(e.sSortableNone)); // Menonaktifkan pengurutan jika fitur pengurutan tidak diaktifkan
      a = -1 !== h.inArray("asc", b.asSorting); // Memeriksa apakah pengurutan naik diizinkan
      c = -1 !== h.inArray("desc", b.asSorting); // Memeriksa apakah pengurutan turun diizinkan
      !b.bSortable || (!a && !c)
        ? ((b.sSortingClass = e.sSortableNone), (b.sSortingClassJUI = "")) // Kelas CSS jika tidak sortable
        : a && !c
        ? ((b.sSortingClass = e.sSortableAsc),
          (b.sSortingClassJUI = e.sSortJUIAscAllowed)) // Kelas CSS untuk pengurutan naik
        : !a && c
        ? ((b.sSortingClass = e.sSortableDesc),
          (b.sSortingClassJUI = e.sSortJUIDescAllowed)) // Kelas CSS untuk pengurutan turun
        : ((b.sSortingClass = e.sSortable), (b.sSortingClassJUI = e.sSortJUI)); // Kelas CSS untuk sortable
    }
    function X(a) {
      if (!1 !== a.oFeatures.bAutoWidth) {
        ...
        for (var c = 0, e = b.length; c < e; c++)
          b[c].nTh.style.width = b[c].sWidth; // Menetapkan lebar kolom sesuai dengan pengaturan
      }
      b = a.oScroll;
      ("" !== b.sY || "" !== b.sX) && Y(a); // Menangani pengguliran jika ada
      w(a, null, "column-sizing", [a]); // Memicu event penyesuaian ukuran kolom
    }
    function la(a, b) {
      var c = Z(a, "bVisible");
      return "number" === typeof c[b] ? c[b] : null; // Mengembalikan indeks kolom yang terlihat
    }
    function $(a, b) {
      var c = Z(a, "bVisible"),
        c = h.inArray(b, c);
      return -1 !== c ? c : null; // Mengembalikan indeks kolom dalam array kolom yang terlihat
    }
    function aa(a) {
      return Z(a, "bVisible").length; // Mengembalikan jumlah kolom yang terlihat
    }
    function Z(a, b) {
      var c = [];
      h.map(a.aoColumns, function (a, d) {
        a[b] && c.push(d); // Mengumpulkan indeks kolom yang sesuai dengan kondisi
      });
      return c; // Mengembalikan array indeks kolom
    }
    function Ha(a) {
      var b = a.aoColumns,
        c = a.aoData,
      ...
      for (f = b.length; d < f; d++)
        if (((l = b[d]), (n = []), !l.sType && l._sManualType))
          l.sType = l._sManualType; // Menetapkan tipe manual jika ada
        else if (!l.sType) {
          g = 0;
          for (j = e.length; g < j; g++) {
            i = 0;
            for (h = c.length; i < h; i++) {
              n[i] === k && (n[i] = x(a, i, d, "type")); // Mendapatkan tipe data untuk setiap sel
              q = e[g](n[i], a); // Mendeteksi tipe data
              if (!q && g !== e.length - 1) break;
              if ("html" === q) break;
            }
            if (q) {
              l.sType = q; // Menetapkan tipe data yang terdeteksi
              break;
            }
          }
          l.sType || (l.sType = "string"); // Default ke tipe string jika tidak ada tipe yang terdeteksi
        }
    }
    function ib(a, b, c, e) {
      var d,
        ...
        for (d = b.length - 1; 0 <= d; d--) {
          ...
          for (g = q.length; f < g; f++)
            if ("number" === typeof q[f] && 0 <= q[f]) {
              for (; l.length <= q[f]; ) Fa(a); // Menambahkan kolom baru jika indeks melebihi panjang kolom saat ini
              e(q[f], o); // Mengaplikasikan pengaturan ke kolom
            } else if ("number" === typeof q[f] && 0 > q[f])
              e(l.length + q[f], o);
            // Mengaplikasikan pengaturan ke kolom menggunakan indeks negatif
            else if ("string" === typeof q[f]) {
              j = 0;
              for (i = l.length; j < i; j++)
                ("_all" == q[f] || h(l[j].nTh).hasClass(q[f])) && e(j, o); // Mengaplikasikan pengaturan ke semua kolom atau kolom dengan kelas tertentu
            }
        }
      if (c) {
        d = 0;
        for (a = c.length; d < a; d++) e(d, c[d]); // Mengaplikasikan pengaturan default ke setiap kolom
      }
    }
    function K(a, b, c, e) {
      var d = a.aoData.length,
        f = h.extend(!0, {}, m.models.oRow, { src: c ? "dom" : "data" });
      f._aData = b; // Menyimpan data yang terkait dengan baris
      a.aoData.push(f); // Menambahkan baris baru ke array aoData
      for (var b = a.aoColumns, f = 0, g = b.length; f < g; f++)
        c && Ia(a, d, f, x(a, d, f)), (b[f].sType = null); // Menyegarkan tipe data kolom jika diperlukan
      a.aiDisplayMaster.push(d); // Menambahkan indeks baris ke daftar tampilan master
      (c || !a.oFeatures.bDeferRender) && Ja(a, d, c, e); // Render baris jika diperlukan
      return d; // Mengembalikan indeks baris yang baru ditambahkan
    }
    function ma(a, b) {
      var c;
      b instanceof h || (b = h(b)); // Jika b bukan instance jQuery, ubah menjadi jQuery object
      return b.map(function (b, d) {
        c = na(a, d); // Memanggil fungsi na untuk mendapatkan data terkait
        return K(a, c.data, d, c.cells); // Memanggil fungsi K untuk memproses data
      });
    }
    ...
    function x(a, b, c, e) {
      var d = a.iDraw,
        ...
        g = a.aoData[b]._aData,
        j = f.sDefaultContent,
        c = f.fnGetData(g, e, { settings: a, row: b, col: c }); // Mendapatkan data dari kolom
      if (c === k)
        return (
          a.iDrawError != d &&
            null === j &&
            ...
            (a.iDrawError = d)), // Log kesalahan jika data tidak ditemukan
          j
        );
      if ((c === g || null === c) && null !== j)
        c = j; // Gunakan konten default jika diperlukan
      else if ("function" === typeof c) return c.call(g); // Panggil fungsi jika c adalah fungsi
      return null === c && "display" == e ? "" : c; // Kembalikan string kosong jika c null dan mode display
    }
    ...
    function Ia(a, b, c, e) {
      a.aoColumns[c].fnSetData(a.aoData[b]._aData, e, {
        ...
        row: b,
        col: c,
      }); // Mengatur data di kolom tertentu
    }

    function Ka(a) {
      return h.map(a.match(/(\\.|[^\.])+/g), function (a) {
        return a.replace(/\\./g, "."); // Memecah string berdasarkan titik dan mengganti escapement
      });
    }

    function R(a) {
      if (h.isPlainObject(a)) {
        // Jika a adalah objek murni
        var b = {};
        h.each(a, function (a, c) {
          c && (b[a] = R(c)); // Rekursif untuk properti objek
        });
        return function (a, c, f, g) {
          var j = b[c] || b._; // Mengambil fungsi yang sesuai dengan kunci
          return j !== k ? j(a, c, f, g) : a; // Kembalikan hasil fungsi atau nilai asli
        };
      }
      if (null === a)
        return function (a) {
          return a; // Kembalikan nilai asli jika a null
        };
      if ("function" === typeof a)
        return function (b, c, f, g) {
          return a(b, c, f, g); // Kembalikan hasil fungsi
        };
      if (
        "string" === typeof a &&
        (-1 !== a.indexOf(".") ||
        ...
        var c = function (a, b, f) {
          var g, j;
          if ("" !== f) {
            j = Ka(f); // Pisahkan f berdasarkan titik
          ...
          return a; // Kembalikan nilai akhir setelah navigasi
        };
        return function (b, d) {
          return c(b, d, a); // Mengembalikan hasil dari fungsi c
        };
      }
      return function (b) {
        return b[a]; // Mengembalikan nilai properti dari objek b
      };
    }

    function S(a) {
      if (h.isPlainObject(a)) return S(a._); // Rekursif untuk objek murni
      if (null === a) return function () {}; // Fungsi kosong jika a null
      if ("function" === typeof a)
        return function (b, e, d) {
          a(b, "set", e, d); // Panggil fungsi dengan set
        };
      if (
        "string" === typeof a &&
        (-1 !== a.indexOf(".") ||
        ...
        return function (c, e) {
          return b(c, e, a); // Mengembalikan hasil dari fungsi b
        };
      }
      return function (b, e) {
        b[a] = e; // Mengatur nilai properti dari objek b
      };
    }
    function La(a) {
      return D(a.aoData, "_aData"); // Mengambil data dari objek DataTable berdasarkan properti _aData
    }

    function oa(a) {
      a.aoData.length = 0; // Mengosongkan array data
      a.aiDisplayMaster.length = 0; // Mengosongkan array tampilan master
      a.aiDisplay.length = 0; // Mengosongkan array tampilan
    }

    function pa(a, b, c) {
      for (var e = -1, d = 0, f = a.length; d < f; d++)
        a[d] == b ? (e = d) : a[d] > b && a[d]--; // Menemukan dan menghapus elemen tertentu dari array
      -1 != e && c === k && a.splice(e, 1); // Menghapus elemen jika ditemukan
    }
    ...
    function ca(a, b, c, e) {
      var d = a.aoData[b],
        f,
        g = function (c, f) {
          for (; c.childNodes.length; ) c.removeChild(c.firstChild); // Menghapus semua child nodes
          c.innerHTML = x(a, b, f, "display"); // Mengisi elemen dengan data tampilan
        };
      if ("dom" === c || ((!c || "auto" === c) && "dom" === d.src))
        d._aData = na(
          ...
          e,
          e === k ? k : d._aData
        ).data; // Mengambil data dari DOM jika sumbernya adalah DOM
      else {
        var j = d.anCells;
        if (j)
          if (e !== k) g(j[e], e); // Memperbarui sel tertentu
          else {
            c = 0;
            for (f = j.length; c < f; c++) g(j[c], c); // Memperbarui semua sel
          }
      }
      d._aSortData = null; // Mengatur ulang data urutan
      d._aFilterData = null; // Mengatur ulang data filter
      g = a.aoColumns;
      if (e !== k) g[e].sType = null; // Mengatur ulang tipe kolom
      else {
        c = 0;
        for (f = g.length; c < f; c++) g[c].sType = null;
        Ma(d); // Mengatur ulang metadata baris
      }
    }
    ...
    function na(a, b, c, e) {
      var d = [],
        ...
        o = a.aoColumns,
        l = a._rowReadObject,
        e = e || l ? {} : [], // Mengatur objek atau array tergantung pada rowReadObject
        q = function (a, b) {
          if ("string" === typeof a) {
            var c = a.indexOf("@");
            -1 !== c && ((c = a.substring(c + 1)), S(a)(e, b.getAttribute(c))); // Mengatur atribut ke objek e
          }
        },
        a = function (a) {
          if (c === k || c === j)
            (g = o[j]),
              ...
              g && g._bAttrSrc
                ? (S(g.mData._)(e, i),
                  q(g.mData.sort, a),
                  q(g.mData.type, a),
                  q(g.mData.filter, a)) // Mengatur data dengan sumber atribut
                : l
                ? (g._setter || (g._setter = S(g.mData)), g._setter(e, i)) // Mengatur data dengan setter jika ada
                : (e[j] = i);
          j++;
        };
      if (f)
        for (; f; ) {
          ...
          if ("TD" == b || "TH" == b) a(f), d.push(f); // Proses setiap sel jika node adalah TD atau TH
          f = f.nextSibling;
        }
      else {
        d = b.anCells;
        f = 0;
        for (b = d.length; f < b; f++) a(d[f]); // Proses setiap sel dari anCells
      }
      return { data: e, cells: d }; // Mengembalikan data dan sel yang diproses
    }
    ...
    function Ja(a, b, c, e) {
      var d = a.aoData[b],
        ...
        q;
      if (null === d.nTr) {
        j = c || Q.createElement("tr"); // Membuat elemen tr baru jika tidak ada
        d.nTr = j;
        d.anCells = g;
        j._DT_RowIndex = b;
        Ma(d);
        ...
        for (q = a.aoColumns.length; l < q; l++) {
          h = a.aoColumns[l];
          i = c ? e[l] : Q.createElement(h.sCellType); // Membuat elemen sel baru atau menggunakan yang ada
          g.push(i);
          if (!c || h.mRender || h.mData !== l)
            i.innerHTML = x(a, b, l, "display"); // Mengisi sel dengan data tampilan
          h.sClass && (i.className += " " + h.sClass); // Menambahkan kelas CSS
          h.bVisible && !c
            ? j.appendChild(i)
            : !h.bVisible && c && i.parentNode.removeChild(i); // Menangani visibilitas sel
          h.fnCreatedCell &&
            h.fnCreatedCell.call(a.oInstance, i, x(a, b, l), f, b, l); // Memanggil callback jika sel dibuat
        }
        w(a, "aoRowCreatedCallback", null, [j, f, b]); // Memanggil callback untuk baris yang dibuat
      }
      d.nTr.setAttribute("role", "row"); // Mengatur atribut peran pada tr
    }
    ...
    function Ma(a) {
      var b = a.nTr,
        c = a._aData;
      if (b) {
        c.DT_RowId && (b.id = c.DT_RowId); // Mengatur ID baris jika ada
        if (c.DT_RowClass) {
          var e = c.DT_RowClass.split(" ");
          a.__rowc = a.__rowc ? Na(a.__rowc.concat(e)) : e; // Menangani kelas CSS baris
          h(b).removeClass(a.__rowc.join(" ")).addClass(c.DT_RowClass); // Menghapus kelas lama dan menambahkan yang baru
        }
        c.DT_RowAttr && h(b).attr(c.DT_RowAttr); // Mengatur atribut pada tr
        c.DT_RowData && h(b).data(c.DT_RowData); // Mengatur data pada tr
      }
    }
    ...
    function jb(a) {
      var b,
        ...
        g = a.nTHead,
        j = a.nTFoot,
        i = 0 === h("th, td", g).length, // Mengecek apakah ada elemen th atau td di thead
        o = a.oClasses,
        l = a.aoColumns;
      i && (d = h("<tr/>").appendTo(g)); // Menambahkan baris baru jika thead kosong
      b = 0;
      for (c = l.length; b < c; b++)
        (f = l[b]),
          (e = h(f.nTh).addClass(f.sClass)), // Menambahkan kelas CSS ke th
          i && e.appendTo(d),
          a.oFeatures.bSort &&
            ...
            !1 !== f.bSortable &&
              ...
              Oa(a, f.nTh, b))), // Menambahkan fitur sorting jika tersedia
          f.sTitle != e.html() && e.html(f.sTitle), // Memperbarui judul th jika berbeda
          Pa(a, "header")(a, e, f, o); // Memanggil callback header
      i && da(a.aoHeader, g); // Memperbarui header
      h(g).find(">tr").attr("role", "row"); // Mengatur atribut peran pada baris header
      h(g).find(">tr>th, >tr>td").addClass(o.sHeaderTH); // Menambahkan kelas CSS ke th dan td di header
      h(j).find(">tr>th, >tr>td").addClass(o.sFooterTH); // Menambahkan kelas CSS ke th dan td di footer
      if (null !== j) {
        a = a.aoFooter[0];
        b = 0;
        for (c = a.length; b < c; b++)
          (f = l[b]),
            (f.nTf = a[b].cell),
            f.sClass && h(f.nTf).addClass(f.sClass); // Menambahkan kelas CSS ke sel footer
      }
    }
    ...
    function ea(a, b, c) {
      ...
      if (b) {
        ...
        for (d = b.length; e < d; e++) {
          ...
          g[e].nTr = b[e].nTr;
          for (f = i - 1; 0 <= f; f--)
            !a.aoColumns[f].bVisible && !c && g[e].splice(f, 1); // Menyembunyikan kolom yang tidak terlihat jika diperlukan
          j.push([]);
        }
        e = 0;
        for (d = g.length; e < d; e++) {
          if ((a = g[e].nTr)) for (; (f = a.firstChild); ) a.removeChild(f); // Menghapus semua child nodes dari tr
          f = 0;
          for (b = g[e].length; f < b; f++)
            if (((o = i = 1), j[e][f] === k)) {
              a.appendChild(g[e][f].cell); // Menambahkan sel ke tr
              for (
                j[e][f] = 1;
                g[e + i] !== k && g[e][f].cell == g[e + i][f].cell;
              ...
              h(g[e][f].cell).attr("rowspan", i).attr("colspan", o); // Mengatur rowspan dan colspan
            }
        }
      }
    }
    function M(a) {
      var b = w(a, "aoPreDrawCallback", "preDraw", [a]); // Memanggil callback sebelum menggambar tabel
      if (-1 !== h.inArray(!1, b))
        C(
          a,
          !1
        ); // Cek apakah ada callback preDraw yang mengembalikan false, jika ada, hentikan drawing
      else {
        var b = [],
          c = 0,
          e = a.asStripeClasses, // Kelas untuk stripe pada baris
          d = e.length,
          f = a.oLanguage,
          g = a.iInitDisplayStart,
          j = "ssp" == B(a), // Cek apakah server-side processing diaktifkan
          i = a.aiDisplay;
        a.bDrawing = !0; // Menandakan bahwa tabel sedang dalam proses drawing
        g !== k &&
          -1 !== g &&
          ((a._iDisplayStart = j ? g : g >= a.fnRecordsDisplay() ? 0 : g),
          (a.iInitDisplayStart = -1)); // Set display start sesuai dengan mode server-side atau client-side
        ...
        if (a.bDeferLoading)
          (a.bDeferLoading = !1),
            ...
            C(
              a,
              !1
            ); // Jika defer loading aktif, reset statusnya dan hentikan drawing
        else if (j) {
          if (!a.bDestroying && !kb(a)) return; // Cek apakah tabel tidak sedang dihancurkan dan fungsi kb mengembalikan true
        } else a.iDraw++;
        if (0 !== i.length) {
          ...
          for (j = j ? 0 : g; j < f; j++) {
            var l = i[j],
              q = a.aoData[l];
            null === q.nTr && Ja(a, l); // Jika row node (nTr) belum dibuat, buat dengan Ja
            l = q.nTr;
            if (0 !== d) {
              // Menambahkan kelas stripe pada row
              var n = e[c % d];
              q._sRowStripe != n &&
                (h(l).removeClass(q._sRowStripe).addClass(n),
                (q._sRowStripe = n));
            }
            w(a, "aoRowCallback", null, [l, q._aData, c, j]); // Panggil callback baris
            b.push(l); // Tambahkan row ke array b
            c++;
          }
        } else {
          // Jika tidak ada data untuk ditampilkan
          c = f.sZeroRecords; // Pesan saat tidak ada data
          1 == a.iDraw && "ajax" == B(a)
            ? (c = f.sLoadingRecords) // Pesan saat data sedang dimuat
            : f.sEmptyTable && 0 === a.fnRecordsTotal() && (c = f.sEmptyTable); // Pesan saat tabel kosong
        ...
        w(a, "aoFooterCallback", "footer", [
          ...
          o,
          i,
        ]); // Panggil callback footer
        e = h(a.nTBody);
        e.children().detach(); // Hapus row sebelumnya
        e.append(h(b)); // Menambahkan row ke dalam tbody
        w(a, "aoDrawCallback", "draw", [a]); // Panggil callback draw
        a.bSorted = !1; // Set bSorted ke false
        a.bFiltered = !1; // Set bFiltered ke false
        a.bDrawing = !1; // Set bDrawing ke false setelah drawing selesai
      }
    }

    function N(a, b) {
      var c = a.oFeatures,
        e = c.bFilter; // Cek apakah fitur filter aktif
      c.bSort && lb(a); // Sort data jika fitur sort aktif
      e ? fa(a, a.oPreviousSearch) : (a.aiDisplay = a.aiDisplayMaster.slice()); // Lakukan pencarian atau salin semua data jika filter tidak aktif
      !0 !== b && (a._iDisplayStart = 0); // Set display start ke awal jika parameter b bukan true
      a._drawHold = b;
      M(a); // Panggil fungsi untuk menggambar tabel
      a._drawHold = !1; // Set draw hold ke false setelah selesai
    }
    ...
    function mb(a) {
      ...
      for (
        ...
        if ("<" == j) {
          ...
          g = nb(a); // Tambahkan kontrol panjang tabel
        else if ("f" == j && e.bFilter) g = ob(a); // Tambahkan kontrol filter
        else if ("r" == j && e.bProcessing)
          g = pb(a); // Tambahkan indikator pemrosesan
        else if ("t" == j) g = qb(a); // Tambahkan tabel utama
        else if ("i" == j && e.bInfo) g = rb(a); // Tambahkan informasi tabel
        else if ("p" == j && e.bPaginate)
          g = sb(a); // Tambahkan kontrol paginasi
        ...
        g &&
          ((i = a.aanFeatures), i[j] || (i[j] = []), i[j].push(g), d.append(g));
      }
      c.replaceWith(d); // Ganti tabel dengan wrapper yang baru
    }
    ...
    function da(a, b) {
      var c = h(b).children("tr"),
        ...
        q,
        n;
      a.splice(0, a.length); // Hapus semua elemen dalam array a
      f = 0;
      for (i = c.length; f < i; f++) a.push([]); // Tambahkan array kosong untuk setiap baris
      f = 0;
      ...
      for (var b = 0, d = c.length; b < d; b++)
        for (var f = 0, g = c[b].length; f < g; f++)
          if (c[b][f].unique && (!e[f] || !a.bSortCellsTop))
            e[f] = c[b][f].cell;
      return e; // Mengembalikan array elemen header yang unik
    }

    function ra(a, b, c) {
      w(a, "aoServerParams", "serverParams", [b]); // Panggil callback serverParams
      if (b && h.isArray(b)) {
        var e = {},
          d = /(.*?)\[\]$/;
      ...
      var f,
        ...
        j = a.oInstance,
        i = function (b) {
          w(a, null, "xhr", [a, b, a.jqXHR]); // Panggil callback xhr
          c(b);
        };
      ...
      o = {
        ...
        error: function (b, c) {
          ...
          C(a, !1); // Hentikan loading jika ada error
        },
      };
      a.oAjaxData = b;
      w(a, null, "preXhr", [a, b]); // Panggil callback preXhr
      a.fnServerData
        ? a.fnServerData.call(
            j,
            a.sAjaxSource,
    ...
    function ub(a, b) {
      ...
      a.bAjaxDataGet = !0;
      C(a, !1); // Set loading state ke false
    }
    ...
    // Fungsi untuk membuat elemen input pencarian dan menangani event search
    function ob(a) {
      var b = a.oClasses,
        c = a.sTableId,
        e = a.oLanguage,
    ...
    // Fungsi untuk memproses pencarian berdasarkan input pengguna
    function fa(a, b, c) {
      ...
      if ("ssp" != B(a)) {
        ...
        for (b = 0; b < d.length; b++)
          wb(
            ...
            d[b].sSearch,
            b,
            d[b].bEscapeRegex !== k ? !d[b].bEscapeRegex : d[b].bRegex,
            d[b].bSmart,
    ...
    // Fungsi untuk menerapkan filter dari ekstensi yang ada
    function xb(a) {
      for (
        var b = m.ext.search, c = a.aiDisplay, e, d, f = 0, g = b.length;
        f < g;
        f++
      ) {
    ...
    // Fungsi untuk memproses pencarian di kolom tertentu
    ...
    // Fungsi untuk menerapkan pencarian pada seluruh data tabel
    ...
    // Fungsi untuk membuat regex dari string pencarian
    function Qa(a, b, c, e) {
      a = b ? a : va(a);
      c &&
        (a =
    ...
    // Fungsi untuk menghindari karakter khusus pada regex
    function va(a) {
      return a.replace(Yb, "\\$1");
    }

    // Fungsi untuk mempersiapkan data filter untuk setiap baris data
    function yb(a) {
      var b = a.aoColumns,
        c,
        e,
    ...
    // Fungsi untuk mengembalikan objek pencarian dengan properti tertentu
    function zb(a) {
      return {
        search: a.sSearch,
        smart: a.bSmart,
    ...
    // Fungsi untuk membuat objek pencarian dengan properti tertentu
    function Ab(a) {
      return {
        sSearch: a.search,
        bSmart: a.smart,
    ...
    // Fungsi untuk membuat elemen informasi tabel (jumlah data, dll.)
    function rb(a) {
      var b = a.sTableId,
        c = a.aanFeatures.i,
        e = h("<div/>", {
    ...
    // Fungsi callback untuk memperbarui informasi tabel
    function Bb(a) {
    ...
    // Fungsi untuk mengganti placeholder di string dengan nilai sebenarnya
    function Cb(a, b) {
    ...
    // Fungsi inisialisasi tabel saat pertama kali di-load
    function ga(a) {
      var b,
        c,
    ...
    function Y(a) {
      ...
      L &&
        ((x = L.clone().prependTo(r)), (u = L.find("tr")), (x = x.find("tr")));
      ...
      if ("" === c) {
        ...
        "" !== e
          ...
          ? ((O.width = s(g - f)), r.outerWidth() > g - f && (O.width = s(g)))
          : (O.width = s(g));
      g = r.outerWidth();
      G(E, y);
      G(function (a) {
      ...
      if (r.outerWidth() < g) {
        u =
          i.scrollHeight > i.offsetHeight || "scroll" == q.css("overflow-y")
            ? g + f
            : g;
        if (
          w &&
      ...
      d &&
        ...
        t.offsetHeight < i.offsetHeight && (n.height = s(t.offsetHeight + b)));
      b = r.outerWidth();
      l[0].style.width = s(b);
      o.width = s(b);
          ...
          for (n = g = 0; n < e.length; n++)
            (m = c[e[n]]),
              ...
              (g +=
                null === m.sWidthOrig
                  ? d
                  : parseInt(m.sWidth, 10) + d - h(i[n]).width());
          j.width(s(g));
          b.style.width = s(g);
        }
        for (n = 0; n < e.length; n++)
        ...
        ? ((c = h.inArray(b, D(d, "0"))),
          -1 !== c
            ? ((b = g(d[c], !0)),
              ...
              null === b ? d.splice(c, 1) : ((d[c][1] = f[b]), (d[c]._idx = b)))
    ...
    function Kb(a) {
      ...
      if (a.oFeatures.bStateSave) {
        ...
        if (
          ...
          d.start !== k &&
            ((a._iDisplayStart = d.start), (a.iInitDisplayStart = d.start));
    ...
    function Lb(a, b, c) {
      ...
      for (d in b)
        b.hasOwnProperty(d) &&
          ((e = b[d]),
          h.isPlainObject(e)
            ? (h.isPlainObject(a[d]) || (a[d] = {}), h.extend(!0, a[d], e))
            : (a[d] =
                c && "data" !== d && "aaData" !== d && h.isArray(e)
                  ? e.slice()
                  : e));
      return a;
    }
    ...
    function w(a, b, c, e) {
      ...
      null !== c &&
        ((b = h.Event(c + ".dt")), h(a.nTable).trigger(b, e), d.push(b.result));
      return d;
    }
    function Sa(a) {
      var b = a._iDisplayStart,
      ...
      this.each(function () {
        ...
        if ("table" != this.nodeName.toLowerCase())
          ...
          null !== d.iDeferLoading &&
            ...
            (p._iRecordsDisplay = g ? d.iDeferLoading[0] : d.iDeferLoading),
            (p._iRecordsTotal = g ? d.iDeferLoading[1] : d.iDeferLoading));
          var t = p.oLanguage;
              ...
              f.on("column-visibility.dt.DT_details", function (a, b) {
                if (d === b)
                  for (var c, e = aa(b), f = 0, h = g.length; f < h; f++)
                    (c = g[f]),
                      c._details &&
                        c._details.children("td[colspan]").attr("colspan", e);
              }),
              ...
              if (a === null || a === k || c) {
                ...
                for (t = g.length; r < t; r++) {
                  ...
                  for (s = 0; s < m; s++) {
                    ...
                    if (c) {
                      v = b.aoData[l];
                      a(u, x(b, l, s), v.anCells ? v.anCells[s] : null) &&
                        o.push(u);
                    } else o.push(u);
                  }
                }
      ...
      header: {
        _: function (a, b, c, e) {
          h(a.nTable).on("order.dt.DT", function (d, f, g, h) {
            if (a === f) {
              d = c.idx;
              b.removeClass(
                c.sSortingClass + " " + e.sSortAsc + " " + e.sSortDesc
              ).addClass(
                h[d] == "asc"
                  ? e.sSortAsc
                  : h[d] == "desc"
        ...
        jqueryui: function (a, b, c, e) {
          h("<div/>")
            ...
            .append(b.contents())
            .append(
              h("<span/>").addClass(e.sSortIcon + " " + c.sSortingClassJUI)
            )
            .appendTo(b);
          h(a.nTable).on("order.dt.DT", function (d, f, g, h) {
            if (a === f) {
              d = c.idx;
              b.removeClass(e.sSortAsc + " " + e.sSortDesc).addClass(
                h[d] == "asc"
                  ? e.sSortAsc
                  : h[d] == "desc"
                  ? e.sSortDesc
