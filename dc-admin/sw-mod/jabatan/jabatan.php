    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <div class="box box-solid">
        <div class="box-header with-border">
          <h3 class="box-title"><b>Data Jabatan RSU AMBON</b></h3>
      ...
      if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          if ($level_user == 1) {
            ...
            onclick="getElementById('txtid').value='<?PHP echo $row['position_id']; ?>';getElementById('txtnama').value='<?PHP echo $row['position_name']; ?>';"><i
