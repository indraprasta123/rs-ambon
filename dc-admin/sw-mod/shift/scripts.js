$(document).ready(function () {
  // Inisialisasi data table dengan panjang tampilan 20 dan pilihan panjang tampilan lainnya
  ...
  // Inisialisasi timepicker dengan format 24 jam
      ...
      $.ajax({
        ...
        success: function (data) {
          if (data == "success") {
            swal({
              title: "Berhasil!",
              text: "Data Shift berhasil disimpan.!",
              icon: "success",
              timer: 1500,
            });
            $("#modalAdd").modal("hide");
