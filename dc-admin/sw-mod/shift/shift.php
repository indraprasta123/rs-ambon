<?php
// Jika koneksi tidak ada, redirect ke halaman login
if (empty($connection)) {
  header('location:../../');
} else {
  // Menentukan lokasi file proses
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <div class="box box-solid">
        <div class="box-header with-border">
          <h3 class="box-title"><b>Data Shift RSU AMBON</b></h3>
          <div class="box-tools pull-right">';
      // Jika pengguna adalah admin (level_user == 1), tampilkan tombol tambah baru
      if ($level_user == 1) {
        echo '
      ...
      if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
          // Menghitung jumlah karyawan untuk setiap shift
          ...
          echo '
                <tr>
                  ...
                  <td>
                    <div class="btn-group">';
          // Jika pengguna adalah admin, tampilkan tombol edit dan hapus
          if ($level_user == 1) {
            echo '
                      <a href="#modalEdit" class="btn btn-warning btn-xs enable-tooltip" title="Edit" data-toggle="modal"'; ?>
            onclick="getElementById('txtid').value='<?PHP echo $row['shift_id']; ?>';getElementById('txtname').value='<?PHP echo $row['shift_name']; ?>';getElementById('txtin').value='<?PHP echo $row['time_in']; ?>';getElementById('txtout').value='<?PHP echo $row['time_out']; ?>';"><i
              class="fa fa-pencil-square-o"></i> Ubah</a>
            <?php echo '
            ...
            // Jika pengguna bukan admin, tampilkan tombol yang dinonaktifkan
            echo '
