...
if (empty($connection)) {
  ...
  // Jika koneksi ada, include panel modul
  include_once 'sw-mod/sw-panel.php';

  echo '
  <div class="content-wrapper">';
  // Switch statement untuk menentukan konten yang ditampilkan berdasarkan parameter 'op'
  switch (@$_GET['op']) {
    default:
      // Tampilan default: Daftar absensi
      echo '
...
<section class="content">
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      // membuat form laporan absensi semua karyawan 
      echo '
            </tbody>
          </table>
          </div>
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  <label>Ruang Kerja</label>
                   <select class="form-control building" name="building"  required="">
                      <option value="">- Pilih -</option>';

      // Query untuk mendapatkan Ruang Kerja
      ...
      // Menentukan bulan berdasarkan variabel $month
      if ($month == 1) {
      ...
      $mulai = date('Y') - 0;
      // Menampilkan tahun dari tahun ini hingga 50 tahun ke depan
...
<section class="content">
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      // Ambil ID dari parameter GET dan gunakan untuk query
      if (!empty($_GET['id'])) {
