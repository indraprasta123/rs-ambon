...
if (empty($connection)) {
  ...
  // Query untuk mendapatkan notifikasi cuti
...
<head>
  ...
  // Include additional CSS based on the module
  if ($mod == 'pendaftar') {
    echo '
...
<body class="sidebar-mini skin-blue-light fixed">';
  // Output the main wrapper and heade
  echo '<div class="wrapper">
    <div class="loading"></div>
<header class="main-header">
    <!-- Logo -->
    <a href="./" class="logo">
      <span class="logo-mini"><b>ABSENSI by Fileo sofio</span>
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                <!-- inner menu: contains the actual data -->
                <ul class="menu">';
  // Menampilkan notifikasi kehadiran
