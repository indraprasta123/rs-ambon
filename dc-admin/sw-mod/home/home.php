<?php
// Mengecek apakah koneksi database tidak ada
if (empty($connection)) {
  // Jika tidak ada koneksi, alihkan pengguna ke halaman utama
  header('location:../../');
} else {
  // Jika koneksi ada, sertakan file panel
...
<section class="content">
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="box-header with-border">
          <h3 class="box-title">Statistik Absensi Pegawai RSU AMBON </h3>
        </div>
          <div class="box-body">
            <div class="chart">
          ...
          <div class="box-body no-padding">
            <table class="table">
              <tbody>
                ...
                <tr>';
  // Query untuk mengambil absensi hari ini
        ...
        <div class="box-header with-border">
          ...
          <table class="table">
            <tbody>
                ...
                <tr>';
  // Query untuk mengambil permohonan cuti yang statusnya '3' (dapat diasumsikan sebagai cuti disetujui)
  ...
  // Mengatur tanggal untuk grafik absensi
  ...
  // Mengumpulkan data absensi untuk grafik
  for ($i = 0; $i <= 6; $i++) {
  ...
  // Mengubah format tanggal visitor menjadi string
  ...
  <script type="text/javascript">
    ...
    // Membuat grafik ketika halaman dimuat
